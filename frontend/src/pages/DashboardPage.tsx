...
function DashboardPage(props: {
  ...
  const options = {
    'Create/Upload an Invoice': { svg: PenSvg, route: '/invoice-creation', cy: 'dashboard-creation' },
    'Validate an Invoice': { svg: TickSvg, route: '/invoice-validation', cy: 'dashboard-validation' },
    'Send an Invoice': { svg: SendSvg, route: '/invoice-sending', cy: 'dashboard-sending' },
    'Manage Invoices': { svg: ManageSvg, route: '/invoice-management', cy: 'dashboard-management' },
    'Account Settings': { svg: CogSvg, route: '/settings', cy: 'dashboard-settings' },
    'Documentation Info': { svg: DocSvg, route: '/documentation', cy: 'dashboard-documentation' },
  };
