            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell align='right'>
                  ${invoiceInfo.totalGST.toLocaleString()}
                </TableCell>
              </TableRow>
              ...
              <TableRow>
                ...
                <TableCell align='right'>
                  ${invoiceInfo.totalTaxable.toLocaleString()}
                </TableCell>
              </TableRow>
              ...
              <TableRow>
                ...
                <TableCell align='right'>
                  ${invoiceInfo.totalAmount.toLocaleString()}
                </TableCell>
              </TableRow>
            </TableBody>
          </Table>
          ...
          {invoiceDocuments.map((document: any, index: number) => (
            <ListItem key={index}>
              <ListItemText
                ...
                secondary={`Size: ${document.fileSize} | Type: ${document.fileMimeType}`}
              />
            </ListItem>
          ))}
        </List>
