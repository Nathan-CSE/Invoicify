...
def test_pdf_create_download_interaction(client, user):
    data = {
...
def test_pdf_create_validate_fail_send_fail_interaction(client, user):
    data = {
        "files": [(io.BytesIO(base64.b64decode(TEST_DATA["PDF_1"])), 'test.pdf')]
    }
...
def test_pdf_create_history_delete_history_interaction(client, user):
    data = {
        "files": [(io.BytesIO(base64.b64decode(TEST_DATA["PDF_1"])), 'test.pdf')]
    }
