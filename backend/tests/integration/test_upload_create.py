...
from tests.urls import INVOICE_CREATE_PATH, INVOICE_DELETE_PATH, INVOICE_DOWNLOAD_PATH, INVOICE_EDIT_PATH, INVOICE_HISTORY_PATH, INVOICE_SEND_PATH, INVOICE_UPLOAD_CREATE_PATH, INVOICE_UPLOAD_VALIDATE_PATH, INVOICE_VALIDATE_PATH
