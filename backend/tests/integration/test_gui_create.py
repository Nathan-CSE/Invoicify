...
def test_gui_create_validate_send_interaction(client, user):
    res = client.post(
        INVOICE_CREATE_PATH,
...
# GUI Create -> Validate (Fail) -> Send (Fail)
def test_gui_create_validate_fail_send_fail_interaction(client, user):
...
# GUI Create -> Validate (Fail) -> Edit -> Validate (Success) -> Send (Success)
def test_gui_create_validate_fail_edit_validate_send_interaction(client, user):
    data = copy.deepcopy(TEST_DATA["JSON"])
    data["seller"]["ABN"] = 123123
...
# GUI Create -> Edit -> Validate (Success) -> Send (Success)
def test_gui_create_edit_validate_send_interaction(client, user):
    data = copy.deepcopy(TEST_DATA["JSON"])
    data["seller"]["ABN"] = 123123
...
# GUI Create -> Edit -> Validate (Fail) -> Send (Fail)
def test_gui_create_edit_validate_fail_send_fail_interaction(client, user):
    res = client.post(
        INVOICE_CREATE_PATH,
        data=json.dumps(TEST_DATA["JSON"]),
        headers={
...
# GUI Create -> Validate (Success) -> Edit -> Validate (Fail) -> Send (Fail)
def test_gui_create_validate_edit_validate_fail_send_fail_interaction(client, user):
    res = client.post(
        INVOICE_CREATE_PATH,
        data=json.dumps(TEST_DATA["JSON"]),
        headers={
...
# GUI Create -> Validate (Success) -> Edit -> Send (Fail)
def test_gui_create_validate_edit_send_fail_interaction(client, user):
    res = client.post(
        INVOICE_CREATE_PATH,
        data=json.dumps(TEST_DATA["JSON"]),
        headers={
...
# GUI Create -> Download (Success)
def test_gui_create_download_interaction(client, user):
    res = client.post(
        INVOICE_CREATE_PATH,
        data=json.dumps(TEST_DATA["JSON"]),
        headers={
