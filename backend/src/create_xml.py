...
def create_xml(file):
    ...
    content = template.format(
        issue_date=variable1, 
        note=variable2, 
        seller_abn=variable3, 
        ...
        tax_per=variable4,
        total_tax=variable3, 
        total_after_tax=variable4,
        amount_product=variable3, 
        cost_product=variable4,
        name_product=variable5,
        tax_amount=variable4
    )
