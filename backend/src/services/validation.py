...
class ValidationService():
    ...
    def validate_xml(self, filename, content, rules):
        ...
        try:
            ...
            # access_token = "eyJraWQiOiJqUWhhc1B3MXlhODluWVV5VDFIWHNab2dJWEJmRXlZWEZPeCtxV01WZHVJPSIsImFsZyI6IlJTMjU2In0..kaPcNEit990hOpaiFk4u_IN51aCJCpVD8urPvCdpUylxOmTuty_26mioRZtPHqrPb4-uqyWqIilYCWg_o3pPMn0PuytwfTeh-5Sr4nuYCjc300-DHjKPaH8sJ2INcPQJLK0byZJwV0PFgtWxzNd6LcD4FN6TbwN_Iep_zMtsNSF3KfAYS9nzoNR8VgRNHaTduIkx7kwGCWlaVXZPhsMnx4mdsWHVxGnl6VSO8YKJaBoW4DKl8nhC7zGTPyl6aYkjdGQcL2nvSpOpv2FhPb9SWWg7JUJUNfi2FdgVqvRd32bcjAdvhHEiMXBjZRljPptUY0DRuePDup17_i1cCPzq3g"
            res = requests.post(
